...
# Credenciales de Supabase (leídas desde st.secrets)
...
try:
    # Traer datos ordenados por Curso y Prioridad
    ...
    # Función corregida para convertir número de asiento a Letra de Fila y Número de Silla
    ...
    # Procesar todos los estudiantes en el orden correcto
    for est in estudiantes:
        cupos_adicionales = est["cupos_adicionales"]
        total_extras_usados += cupos_adicionales
        
        total_asientos = 2 + cupos_adicionales  # Graduando + 2 base + extras
        ...
        if str(est["id"]) == str(id_escaneado):
            ...
            # Formatear el texto de la ubicación de forma uniforme
    ...
    # 5. DISEÑO DE LA INTERFAZ DE ACCESO (Centrada y VIP)
